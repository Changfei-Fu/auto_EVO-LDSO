...
###If the results folder exist, this function generate a KeyframeTrajectory into this folder###
...
def evo_data(data_Path,times):#输入某个数据集地址
    ...
    if not os.path.exists(results_Path+"/rgb.csv"):
        os.system("cp "+data_Path+"/dso/cam0/data.csv "+results_Path+"/rgb.csv")
